...
class ShellRouteTransitions {
  ...
  static CustomRouteTransitionBuilder get slideHorizontal => _slideHorizontalTransition;
  static CustomRouteTransitionBuilder get slideVertical => _slideVerticalTransition;
  ...
  static Widget _slideHorizontalTransition({
    ...
    if (index == currentIndex && index != nextIndex) {
      ...
      offsetX = isMovingForward ? 1.0 - animation.value : -1.0 + animation.value;
      opacity = animation.value;
    } else if (index == currentIndex && index == nextIndex) {
      offsetX = 0.0;
      opacity = 1.0;
  ...
  static CustomRouteTransitionBuilder createCustomTransition(CustomRouteTransitionBuilder builder) {
    return builder;
  }
}
